...
use Modules\Page\Transformers\PageBlockTransformer;
...
class BlockApiController extends BaseApiController
{
  ...
  public function index(Request $request)
  {
    try {
      ...
      //Response
      $response = [
        "data" => PageBlockTransformer::collection($dataEntity)
      ];
  ...
  public function show($criteria, Request $request)
  {
    try {
      ...
      //Response
      $response = ["data" => new PageBlockTransformer($dataEntity)];
