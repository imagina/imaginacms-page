...
use Modules\Page\Transformers\PageComponentTransformer;

class ComponentApiController extends BaseApiController
{
  /**
  ...
  public function index(Request $request)
  {
    try {
      ...
      //Response
      $response = [
        "data" => PageComponentTransformer::collection($dataEntity)
      ];
  ...
  public function show($criteria, Request $request)
  {
    try {
      ...
      //Response
      $response = ["data" => new PageComponentTransformer($dataEntity)];
